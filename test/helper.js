...
exports.createVisibleJobWithHtmlInSomeYearsOld = createVisibleJobWithHtmlInSomeYearsOld;
exports.createVisibleJobCreatedJustNow = createVisibleJobCreatedJustNow;


/* create2 jobs - 1 not visible, 2 visible */
exports.createThreeJobs = createThreeJobs;

function createThreeJobs(done) {
  var job1 = new Job({
...
function createVisibleJobCreatedJustNow(cb) {
  var job2 = new Job({
...
function createVisibleJobWithHtmlInSomeYearsOld(cb) {
